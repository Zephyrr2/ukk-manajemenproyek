                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div class="ml-4">
                            ...
                            <p class="text-blue-100">Set up a new project with team assignments and requirements</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description"
                                      ...
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('description') border-red-500 ring-2 ring-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="hidden" id="team_lead_id" name="team_lead_id" value="{{ old('team_lead_id') }}">
...
function searchTeamLeaders(query) {
    ...
    fetch(`{{ route('admin.search.leaders') }}?q=${encodeURIComponent(query)}`, {
        method: 'GET',
        headers: {
